...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Produc> products = [
    Produc('assets/cap_1.png', 'Indian Cap', 'description', 25.3),
    Produc('assets/womanshoe_1.png', 'Women Shoes ', 'description', 32.3),
    Produc('assets/ring_10.png', 'Engagement ring', 'description', 58.3)
  ];
